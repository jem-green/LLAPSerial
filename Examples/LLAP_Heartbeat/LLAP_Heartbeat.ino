...
const String deviceName PROGMEM = "HEARTBEAT";  // The Device friendly naem
const String deviceType PROGMEM = "HBEAT001";  // The user defined device type
      ...
      default:
        {
          if (LLAP.bMsgReceived == true)   // Check if there is a message
          {
            ...
            {
              // The specification implies that the DEVICEID doesnt get used until a reboot.
